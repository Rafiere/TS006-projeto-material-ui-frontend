...
interface IFerramentasDeDetalheProps {
    ...
    mostrarBotaoNovo?: boolean; //Em alguns momentos, um botão dessa barra de ferramentas pode ter que ser ocultado, assim, basta passarmos o valor de "false" para essa propriedade quando isso ocorrer.
...
export const FerramentasDeDetalhe: React.FC<IFerramentasDeDetalheProps> = ({
    ...
    const smDown = useMediaQuery(theme.breakpoints.down('sm')); //Obtendo o tamanho atual das telas para escondermos ou não determinados botões.
